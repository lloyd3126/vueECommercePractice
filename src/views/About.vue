...
<script>
import MainNavbarFixed from '@/components/MainNavbarFixed';
...
export default {
  ...
  data() {
    return {
      ...
      couponImgUrl: './img/coupon_link.jpg',
      popularImgUrl: './img/popular_link.jpg',
      saleImgUrl: './img/sale_link.jpg',
      scrollNum: 0,
    };
  },
  methods: {
